...
# background sync — see its own README for why that's a deliberately
# different shape from Athenaeum's hourly vault sync.
CODEBASE_SEARCHER_URL = os.environ.get("CODEBASE_SEARCHER_URL", "http://192.168.1.157:8300")
